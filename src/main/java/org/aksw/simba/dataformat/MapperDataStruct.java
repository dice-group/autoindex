...
public class MapperDataStruct {
	...
	public MapperDataStruct(List<String> URIs, List<String> Labels,
			List<Double> EnergyScore) {
	...
	public void setEnergyScore(List<Double> EnergyScore) {
		this.EnergyScore.clear();
		this.EnergyScore.addAll(EnergyScore);
	}
	...
	public List<Double> getEnergyScore() {
