...
public class ResultDataStruct {
	...
	public ResultDataStruct(String URI, Double explaination_score,
			Double energy_score, int begin, int end) {
	...
	public ResultDataStruct(String URI, Double explaination_score,
			Double energy_score, Set<Integer> colors) {
		this.scores.add(explaination_score);
		this.scores.add(energy_score);
		this.URI = URI;
	...
	public Double getExplainationScore() {
	...
	public void setExplainationScore(Double explaination_score) {
		this.scores.set(0, explaination_score);
	}

	public void setEnergyScore(Double energy_score) {
		this.scores.set(1, energy_score);
	}
	...
	public void setActivation(String Method) {
	...
	public static Set<Integer> intersect(Set<Integer> Setcolors1,
			Set<Integer> Setcolors2) {
	...
	public static Set<Integer> union(Set<Integer> Setcolors1,
			Set<Integer> Setcolors2) {
		Set<Integer> secondcolors = new HashSet<Integer>();
		secondcolors.addAll(Setcolors1);
		Set<Integer> firstcolors = new HashSet<Integer>();
